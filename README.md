...
October 2022: Paper accepted to NeurIPS 2022
...
Small example of 10 video and labels (.mat format - 1.2GB) can be downloaded [here](https://facesyntheticspubwedata.z6.web.core.windows.net/neurips-2022/scamps_videos_example.tar.gz)

The full set of videos and labels (.mat format - 600GB) can be downloaded [here](https://facesyntheticspubwedata.z6.web.core.windows.net/neurips-2022/scamps_videos.tar.gz)

The full set of labels only (.mat format - 500MB) can be downloaded [here](https://facesyntheticspubwedata.z6.web.core.windows.net/neurips-2022/scamps_waveforms.tar.gz)

The full set of labels only (.csv format - 60MB) can be downloaded [here](https://facesyntheticspubwedata.z6.web.core.windows.net/neurips-2022/scamps_waveforms_csv.tar.gz)

A CSV file with official **Train**, **Validation** and **Test** splits [here](https://facesyntheticspubwedata.z6.web.core.windows.net/neurips-2022/ScampsTrainTestSplit.csv)
